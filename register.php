    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="register_crud.php" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Role is required">
                        <select class="input100" name="position" required>
                            <option value="" disabled selected>Select role</option>
                            <option value="Supervisor">Supervisor</option>
                        </select>
                        <span class="focus-input100"></span>
                        <span class="symbol-select100">
                    ...
                    <div class="text-center p-t-135">
                        <a class="txt2" href="Login.php">Back
